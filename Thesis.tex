...
\input{./Chapters/02_scacef} % Experimental Setup

\lhead{\emph{Coronary Artery Stenoses Detection}}  
\input{./Chapters/03_casd} % Experimental Setup

\lhead{\emph{Evaluation}}  
\input{./Chapters/04_Evaluation} % Experimental Setup

\lhead{\emph{Evaluation}}  
\input{./Chapters/05_Results} % Experimental Setup
